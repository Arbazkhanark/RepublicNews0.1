...
// import "./globals.css";
// import { Toaster } from "sonner";
// import ClientScripts from "@/components/public/ClientScripts";

// // Load Inter font from Google with proper optimization
// const inter = Inter({ 
//   subsets: ["latin", "devanagari"], // Add devanagari for Hindi support
//   variable: "--font-inter",
...
//   manifest: '/site.webmanifest',
//   verification: {
//     google: '_zF81fS4jGAvmC9QBsZxhNR8tk4I4nZwLjeRGASgO0I', // Your Google Search Console verification code
//   },
//   category: 'news',
//   classification: 'News Media',
//   other: {
...
//     <html lang="en" dir="ltr" className={inter.variable}>
//       <head>
//         {/* HTML file verification method - this is the file you uploaded */}
//         {/* The file googledeee9f1a08f3bc05.html should be placed in public folder */}
...
//         {/* Google Site Verification Meta Tag - Alternative method */}
//         <meta name="google-site-verification" content="_zF81fS4jGAvmC9QBsZxhNR8tk4I4nZwLjeRGASgO0I" />
//       </head>
      
//       {/* Client-side scripts moved to separate component */}
//       <ClientScripts />
...
export default function RootLayout({
  ...
  return (
    <html lang="en" dir="ltr" className={notoSansDevanagari.variable}>
      <head>
        {/* HTML file verification method - this is the file you uploaded */}
        {/* The file googledeee9f1a08f3bc05.html should be placed in public folder */}
