...
//   // Fix for marquee width issue
//   useEffect(() => {
//     const updateMarqueeWidth = () => {
//       if (marqueeRef.current) {
//         const container = marqueeRef.current.parentElement;
//         if (container) {
//           // Ensure marquee doesn't exceed container width
//           const containerWidth = container.offsetWidth;
//           const marqueeContent = marqueeRef.current.querySelector('.marquee-content');
//           if (marqueeContent) {
//             marqueeContent.style.width = `${containerWidth}px`;
//           }
//         }
//       }
//     };
...
//     updateMarqueeWidth(); // Initial update
...
//       <header className="sticky top-0 z-50 w-full border-b bg-white/95 backdrop-blur supports-[backdrop-filter]:bg-white/60">
//         <div className="container mx-auto px-4">
//           {/* Top Bar with Breaking News Ticker - Fixed width issue */}
//           <div className="hidden md:flex items-center justify-between py-2 border-b">
...
//               <Link href="/" className="text-gray-700 hover:text-red-600 font-medium transition-colors whitespace-nowrap">
//                 Home
//               </Link>
//               <Link href="/fake-news" className="text-red-600 font-semibold border-b-2 border-red-600 pb-1 whitespace-nowrap">
//                 Fake News Debunker
//               </Link>
//               <Link href="/fact-check" className="text-gray-700 hover:text-red-600 font-medium transition-colors whitespace-nowrap">
//                 Fact Check
//               </Link>
//               <Link href="/reports" className="text-gray-700 hover:text-red-600 font-medium transition-colors whitespace-nowrap">
//                 Reports
//               </Link>
//               <Link href="/about" className="text-gray-700 hover:text-red-600 font-medium transition-colors whitespace-nowrap">
//                 About Us
//               </Link>
//               <Link href="/contact" className="text-gray-700 hover:text-red-600 font-medium transition-colors whitespace-nowrap">
//                 Contact
//               </Link>
//             </nav>
...
//             <div className="md:hidden border-t py-4">
//               <div className="flex flex-col gap-4">
//                 <Link href="/" className="text-gray-700 hover:text-red-600 font-medium py-2" onClick={() => setMobileMenuOpen(false)}>
//                   Home
//                 </Link>
//                 <Link href="/fake-news" className="text-red-600 font-semibold py-2" onClick={() => setMobileMenuOpen(false)}>
//                   Fake News Debunker
//                 </Link>
//                 <Link href="/fact-check" className="text-gray-700 hover:text-red-600 font-medium py-2" onClick={() => setMobileMenuOpen(false)}>
//                   Fact Check
//                 </Link>
//                 <Link href="/reports" className="text-gray-700 hover:text-red-600 font-medium py-2" onClick={() => setMobileMenuOpen(false)}>
//                   Reports
//                 </Link>
//                 <Link href="/about" className="text-gray-700 hover:text-red-600 font-medium py-2" onClick={() => setMobileMenuOpen(false)}>
//                   About Us
//                 </Link>
//                 <Link href="/contact" className="text-gray-700 hover:text-red-600 font-medium py-2" onClick={() => setMobileMenuOpen(false)}>
//                   Contact
//                 </Link>
//                 <div className="pt-4 border-t">
//                   <div className="relative">
...
//                               <CardFooter className="bg-gray-50 flex justify-between flex-wrap gap-4">
//                                 <div className="flex items-center gap-4">
//                                   <Button 
//                                     variant={newsItem.hasVoted === "helpful" ? "default" : "ghost"}
//                                     size="sm" 
